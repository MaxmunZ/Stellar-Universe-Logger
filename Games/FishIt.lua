...
local function CreatePage(name, scroll)
    ...
    if scroll then P.ScrollBarThickness = 2; P.CanvasSize = UDim2.new(0, 0, 0, 500); P.ScrollBarImageColor3 = Color3.fromRGB(255, 50, 150) end
...
local WebhookURL = Instance.new("TextBox", WebhookPage); WebhookURL.Size = UDim2.new(0.9, 0, 0, 35); WebhookURL.Position = UDim2.new(0.05, 0, 0, 50); WebhookURL.BackgroundColor3 = Color3.fromRGB(30, 30, 40); WebhookURL.PlaceholderText = "Webhook URL Here"; WebhookURL.Text = ""; WebhookURL.TextColor3 = Color3.new(1, 1, 1); Instance.new("UICorner", WebhookURL)
...
AddWhFilter("Tier Filter", 95, true); AddWhFilter("Variant Filter", 135, false)
...
AddWhToggle("Send Fish Webhook", 175)

local TestBtn = Instance.new("TextButton", WebhookPage); TestBtn.Size = UDim2.new(0.9, 0, 0, 35); TestBtn.Position = UDim2.new(0.05, 0, 0, 220); TestBtn.BackgroundColor3 = Color3.fromRGB(45, 45, 55); TestBtn.Text = "Tests Webhook Connection"; TestBtn.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", TestBtn)
