...
SearchMenu.Image = GetStellarAsset("StellarBG_Vertical.png", "https://raw.githubusercontent.com/MaxmunZ/Stellar-Assets/refs/heads/main/Stellar%20Background%20Vertical.png")
...
WhTitle.Text = "Webhook Settings"; WhTitle.Size = UDim2.new(1, 0, 0, 30); WhTitle.Position = UDim2.new(0, 20, 0, 10); WhTitle.Font = Enum.Font.GothamBold; WhTitle.TextSize = 18; WhTitle.TextColor3 = Color3.new(1,1,1); WhTitle.BackgroundTransparency = 1; WhTitle.TextXAlignment = Enum.TextXAlignment.Left

local Line = Instance.new("Frame", WebhookPage)
Line.Size = UDim2.new(0, 250, 0, 2); Line.Position = UDim2.new(0, 20, 0, 40); Line.BorderSizePixel = 0
local LGrad = Instance.new("UIGradient", Line)
LGrad.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 50, 150)), ColorSequenceKeypoint.new(1, Color3.fromRGB(25, 25, 35))})

-- 2. Fungsi AddInput (Fixed Global Variables)
local DiscordIDBox, WebhookURLBox -- Kita buat variabel penampung di luar agar bisa diakses tombol Test

local function AddInput(lbl, y, placeholder)
    local L = Instance.new("TextLabel", WebhookPage)
    L.Text = lbl; L.Size = UDim2.new(0.9, 0, 0, 20); L.Position = UDim2.new(0.05, 0, 0, y); L.Font = Enum.Font.GothamMedium; L.TextColor3 = Color3.fromRGB(200, 200, 200); L.TextSize = 15; L.TextXAlignment = Enum.TextXAlignment.Left; L.BackgroundTransparency = 1

    local I = Instance.new("TextBox", WebhookPage)
    I.Size = UDim2.new(0.9, 0, 0, 30); I.Position = UDim2.new(0.05, 0, 0, y + 25); I.BackgroundColor3 = Color3.fromRGB(30, 30, 40); I.PlaceholderText = placeholder; I.Text = ""; I.TextColor3 = Color3.new(1, 1, 1); I.TextSize = 13; I.ClipsDescendants = true; I.ClearTextOnFocus = false; I.TextXAlignment = Enum.TextXAlignment.Left 
    Instance.new("UIPadding", I).PaddingLeft = UDim.new(0, 10); Instance.new("UICorner", I)
    return I
end

DiscordIDBox = AddInput("Input ID Discord", 65, "Ex: 123456789012345678")
WebhookURLBox = AddInput("Webhook URL", 125, "Ex: https://discord.com/api/webhooks/...")

-- 3. Fungsi AddWhFilter (Multi-Select Fix)
...
-- 4. Fungsi Toggle (Text Size Enlarged)
...
AddWhToggle("Send Fish Webhook", 315)
