...
-- Membuat Window Utama yang bisa digeser (Draggable)
local Window = OrionLib:MakeWindow({
    ...
    Icon = "rbxassetid://1000304092" -- Identitas Logo Stellar
})
...
-- [[ TAB 2: FISHING ]]
local Tab2 = Window:MakeTab({Name = "Fishing", Icon = "rbxassetid://4483345998"})
