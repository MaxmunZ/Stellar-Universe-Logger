...
-- Fix: Added Discord ID, Webhook URL, and Name Filter to Webhook Page
...
local function CreatePage(name, scroll)
    ...
    if scroll then P.ScrollBarThickness = 2; P.CanvasSize = UDim2.new(0, 0, 0, 520); P.ScrollBarImageColor3 = Color3.fromRGB(255, 50, 150) end
...
local DiscordID = AddInput("Input ID Discord", 90) --
...
AddFilter("Name Filter", 300, false) -- Menambahkan Name Filter
...
AddToggle("Send Fish Webhook", 345)

local TestBtn = Instance.new("TextButton", WebhookPage); TestBtn.Size = UDim2.new(0.9, 0, 0, 35); TestBtn.Position = UDim2.new(0.05, 0, 0, 390); TestBtn.BackgroundColor3 = Color3.fromRGB(45, 45, 55); TestBtn.Text = "Tests Webhook Connection"; TestBtn.TextColor3 = Color3.new(1, 1, 1); Instance.new("UICorner", TestBtn)
